import { Avatar, Grid, IconButton, List, ListItem, ListItemAvatar, ListItemText, Typography, Button, TextField, Stack } from "@mui/material"; 
                    ...
                    Object.keys(productsCart).map(id => {
                        return <ListItem sx={{
                                    ...
                                    <ListItemAvatar 
                                        ...
                                        <div style={{
                                            backgroundImage: `url("${productsCart[id].image[0]}")`
                                        }}></div>
                                    </ListItemAvatar>
                                    <Stack 
                                        sx={{
